...
const SCREEN_META = {
  ...
  urgent:   { eyebrow: "Внимание / срочно",   title: "Критические сигналы",         subtitle: "Быстрый фокус на рисках, просадках и ситуациях, которые требуют реакции руководителя." },
  "lead-leakage": { eyebrow: "Анализ слива лидов", title: "Где теряются лиды",       subtitle: "Причины потерь, слабые места в обработке обращений и повторяющиеся риски в продажах." },
  growth:   { eyebrow: "Точки роста",         title: "Что делать дальше",           subtitle: "Приоритетные действия после аудита: что исправить первым и где будет заметный эффект." },
